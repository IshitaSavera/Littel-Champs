...
public class AfterNo extends AppCompatActivity {

    TextView lbl1,lbl2;
    EditText num;
    Button button;
    ImageView iv,iv1;
    String n1[] = {"91","95","10","83","12","16","70","29","61","7","39","53","46","17","19","3","99"};
    int i=0,j;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_after_no);

        getSupportActionBar().setTitle("After No.");
