...
public class MiddleNo extends AppCompatActivity {

    TextView lbl1,lbl2,lbl3;
    EditText num;
    Button button;
    ImageView iv,iv1;
    String n1[] = {"90","95","10","83","12","16","70","29","61","7","39","53","46","17","19","3","99"};
    int i=0,j,k;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_middle_no);

        getSupportActionBar().setTitle("Between No.");
